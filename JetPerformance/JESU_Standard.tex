...
In the standard \pt{} balance method, one of the jets is required to be in a reference region where the jet is well calibrated and understood.
...
Using this standard method, an asymmetry , $\mathcal{A}_{ik}$, is obtained in bins of $\eta$ and $\phi$.
