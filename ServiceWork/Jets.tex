...
\dr{} between the offline jet and all L2 jets in the event, shown with range (a) $0 - 6$ and (b) $0 - 1$.
\label{SW_jet_L2_dR}}
\end{figure}
...
\dr{} between the offline jet and all EF jets in the event, shown with range (a) $0 - 6$ and (b) $0 - 1$. 
\label{SW_jet_EF_dR}}
\end{figure}
