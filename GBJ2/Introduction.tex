...
There was a relatively small number of events at large \dy{} where the statistical uncertainties were large. 
The data was compared to state of the art theory predictions by HEJ and POWHEG.

The analysis was extended to probe the gap fraction at a larger \dy{} region.
This larger \dy{} region is again studied using the 2010 data, but using a new dijet trigger strategy that allowed measurements up to $\dy{}=8$, which is the limit of the detector.
